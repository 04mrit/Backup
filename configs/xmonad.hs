...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    --app sourtcut
    , ((controlMask, xK_1), spawn "exec /bin/firefox")
    , ((controlMask, xK_2), spawn "exec /bin/teams")
    , ((controlMask, xK_3), spawn "exec /bin/code")
    , ((controlMask, xK_4), spawn "exec /bin/spotify")
    , ((controlMask, xK_5), spawn "exec /bin/nautilus")
